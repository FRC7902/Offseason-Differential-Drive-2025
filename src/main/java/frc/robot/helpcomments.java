...
import frc.robot.commands.BaseSetpoint;
import frc.robot.commands.ExampleCommand;
import frc.robot.commands.MoveArmDownCmd;
...
public class RobotContainer {
  ...
  final static CommandPS5Controller m_operatorController = new CommandPS5Controller(OperatorConstants.kDriverControllerPort);
